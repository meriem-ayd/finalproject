    ...
    <div class="container-scroller">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row mb-3">
            <div class="col">
              <input type="text" id="searchInput" class="form-control" placeholder="Rechercher par CINDEX">
            </div>
          </div>
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-header text-center bg-white">
                <h4 class="card-title">Stock Médicament</h4>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                    <table id="listedci" class="table">
                      <thead>
                        <tr>
                          <th>CINDEX</th>
                          <th>DCI</th>
                      ...
                      <tbody>
                        ...
                        <tr id="row{{ $dci->id }}">
                          ...
                          <td>{{ $dci->Montant }}</td>
                          <td>
                            <button class="btn btn-outline-primary" data-toggle="modal" data-target="#modifierModal{{ $dci->id }}" title="Modifier {{ $dci->dci }}" >Modifier</button>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
...
<script>
  ...
  $(document).ready(function() {
    $('#searchInput').on('keyup', function() {
      ...
      $('#listedci tbody tr').filter(function() {
