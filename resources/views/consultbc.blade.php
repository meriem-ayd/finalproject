                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <p><strong>Date: {{ $bonDeCommande->date }}</strong></p>
                                    <p> <strong>Service: {{ $bonDeCommande->service ? $bonDeCommande->service->nom_service : 'N/A' }}</strong></p>
                                    <p> <strong>Médecin: {{ $bonDeCommande->medecin ? $bonDeCommande->medecin->user->name : 'N/A' }}</strong></p>
                                ...
                                <form action="{{ route('bonlivraison.create', $bonDeCommande->id) }}" method="GET">
                                    <button type="submit" class="btn btn-outline-primary" style="margin-top: 5px;">Livrer</button>
                                </form>
                            </div>
                        </div>
                    </div>
