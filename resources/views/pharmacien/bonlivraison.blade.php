                                            ...
                                            <form action="{{ route('bonlivraisonord.store', ['id_ordonnance' => $ordonnance->id]) }}" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="form-group row" style=" font-weight: bold;">
                                                        <label class="col-sm-3 col-form-label"> N° Ordonnance :</label>
                                                        <div class="col-sm-2">
                                                    ...
                                                    <div class="form-group row" style=" font-weight: bold;">
                                                        <label for="date" class="col-sm-2 col-form-label">En Date du:</label>
                                                        <div class="col-sm-10">
                                                            <input type="date" name="date" required class="short-input" style="border: none; font-weight: bold; ">
                                                        </div>
