                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header text-center bg-white">
                                <h4 class="card-title">Résultats de l'état du stock</h4>
                            </div>
                            <p style="font-weight: bold;">Période : {{ $startDate->format('d/m/Y') }} - {{ $endDate->format('d/m/Y') }}</p>
                            <div class="row">
                                <div class="col-12">
                                    <table id="order-listing" class="table">
                                        ...
                                        <tbody>
                                            @foreach($etatStock as $etat)
                                            <tr>
                                                <td>{{ $etat['IDdci'] }}</td>
                                                <td>{{ $etat['dci'] }}</td>
                                                <td>{{ $etat['quantite_livree'] }}</td>
                                                <td>{{ $etat['quantite_recue'] }}</td>
                                    ...
                                    <a  href="{{ route('showEtatStockForm') }}" class="btn btn-light" style="margin-top: 5px; border: 1px solid #65D7CA;">Retour</a>
